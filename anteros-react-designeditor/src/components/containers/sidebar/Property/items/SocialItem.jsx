    ...
    return (<div className="ds-widget ds-link-widget social-panel">
      <div className="card-row">
        <div className="ds-widget-label col-6">
          <label className="ds-label-primary"><span>Ícones</span></label>
        </div>
      </div>
        ...
        <SortContainer onSortEnd={this.onSortEnd} useDragHandle>
          {items.map((value, index) => (
            <SortItem
              ...
              key={value.guid}
              index={index}
              onModifyItem={(icon, url) => this.modifyItem(value.guid, icon, url)}
  ...
  return <div key={value.guid}>
    <div className="social-item-card" >
      <div>
        ...
        <a href="javascript:void(0)" className="social-delete-button" onClick={() => { onDeleteItem(); }} ><i className="fal fa-trash" /></a>
      </div>
