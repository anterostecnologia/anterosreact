    ...
    return (<div className="ds-widget ds-link-widget">
      ...
      <div className="card-row" style={{ marginTop: 10 }}>
        <div className="col-12">
          <label
            ...
            <div>
              {!this.state.uploading && <span>Solte uma nova imagem aqui ou clique para selecionar os arquivos a serem enviados.</span>}
              {this.state.uploading && <div>
                <p style={{ fontSize: '12px' }}>Subindo</p>
      ...
      <div className="card-row" style={{ marginTop: 10 }}>
        <div className="ds-widget-label col-12">
          <label className="ds-label-primary"><span>URL da imagem</span></label>
        </div>
      </div>
      <div className="card-row" style={{ marginTop: 10 }}>
        <div className="col-12">
      ...
      </div>
      {
        options && <React.Fragment>
          <div className="card-row" style={{ marginTop: 10 }}>
            <div className="ds-widget-label col-12">
              <label className="ds-label-primary"><span>Opções da imagem</span></label>
            </div>
          </div>
          <div className="card-row" style={{ marginTop: 10 }}>
            <div className="col-6">
