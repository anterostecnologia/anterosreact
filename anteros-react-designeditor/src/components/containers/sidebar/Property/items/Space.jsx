...
class Space extends React.Component {
  ...
  render() {
    const { title = 'Espaçamento' } = this.props;
    return <div className="ds-widget ds-link-widget">
      ...
      {this.state.more && <div className="card-row more-options" style={{ marginTop: 10 }}>
        <div className="col-6">
          <div className="ds-widget-label"><label><span>Topo</span></label></div>
        ...
        <div className="col-6">
          <div className="ds-widget-label"><label><span>À direita</span></label></div>
          <div className="ds-color-picker">
        ...
        <div className="col-6">
          <div className="ds-widget-label"><label><span>Abaixo</span></label></div>
          <div className="ds-color-picker">
      ...
      {!this.state.more && <div className="card-row" style={{ marginTop: 10 }}>
        <div className="col-6">
          <div className="ds-widget-label"><label><span>Todos os lados</span></label></div>
          <div className="ds-color-picker">
