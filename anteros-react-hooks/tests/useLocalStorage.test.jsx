...
describe(useLocalStorage, () => {
    ...
    it('sets localStorage from the function updater', () => {
        const { result, rerender } = renderHook(() => useLocalStorage('foo', { foo: 'bar' }));
        const [, setFoo] = result.current;
        act(() => setFoo((state) => (Object.assign(Object.assign({}, state), { fizz: 'buzz' }))));
        rerender();
    ...
    it('rejects nullish or undefined keys', () => {
        const { result } = renderHook(() => useLocalStorage(null));
        try {
            (() => {
