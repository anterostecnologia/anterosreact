    ...
    <Layout>
      <Header style={{ padding: '0 20px', backgroundColor: '#001529' }}>
        <Stack distribution='equalSpacing' alignment='center'>
          <h1 style={{ color: 'white', margin: '15px 0' }}>anteros-email</h1>

          <div style={{ marginTop: 10 }}>
            <Stack>
              <a
                className='github-button'
                href='https://github.com/arco-design/anteros-email'
                data-size='large'
                data-icon='octicon-star'
                data-show-count='true'
                aria-label='Star m-Ryan/anteros-email on GitHub'
              ...
              <a
                className='github-button'
                href='https://github.com/arco-design/anteros-email/fork'
                data-size='large'
                data-show-count='true'
                aria-label='Fork m-Ryan/anteros-email on GitHub'
              ...
              <a
                className='github-button'
                href='https://github.com/arco-design/anteros-email/issues'
                data-size='large'
                data-show-count='true'
                aria-label='Issue m-Ryan/anteros-email on GitHub'
