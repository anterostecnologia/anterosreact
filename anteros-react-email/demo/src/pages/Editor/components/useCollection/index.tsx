...
import { CollectedBlock, IconFont } from '@anterostecnologia/anteros-email-editor';
import { BlockMarketCategory, BlockMaskWrapper } from '@anterostecnologia/anteros-email-extensions';
