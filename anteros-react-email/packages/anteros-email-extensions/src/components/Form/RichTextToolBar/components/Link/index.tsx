...
import { IconFont, Stack, TextStyle } from '@anterostecnologia/anteros-email-editor';
                ...
                <Grid.Row>
                  <Grid.Col span={12}>
                    <Space align='center' size='mini'>
                      <TextStyle size='smallest'>Destino</TextStyle>
                      <SwitchField
                        size='small'
                        label='Destino'
                        labelHidden
                  ...
                  <Grid.Col span={12}>
                    <Space align='center' size='mini'>
                      <TextStyle size='smallest'>Sublinhado</TextStyle>
                      <SwitchField
                        size='small'
                        label='Sublinhado'
                        labelHidden
