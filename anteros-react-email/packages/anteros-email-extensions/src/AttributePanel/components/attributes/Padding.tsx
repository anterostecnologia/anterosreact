...
import { useFocusIdx, Stack, useBlock, TextStyle } from '@anterostecnologia/anteros-email-editor';
import { createBlockDataByType } from '@anterostecnologia/anteros-email-core';
...
export function Padding(props: PaddingProps = {}) {
  const { title = 'Espaçamento', attributeName = 'padding', name } = props;
        ...
        return (
          <>
            <Stack vertical spacing='extraTight'>
              ...
              <Grid.Row>
                <Grid.Col span={11}>
                  <InputWithUnitField label='Topo' name='top' />
                </Grid.Col>
                <Grid.Col offset={1} span={11}>
                  <InputWithUnitField label='Esquerda' name='left' />
                </Grid.Col>
              </Grid.Row>

              <Grid.Row>
                <Grid.Col span={11}>
                  <InputWithUnitField label='Abaixo' name='bottom' />
                </Grid.Col>
                <Grid.Col offset={1} span={11}>
                  <InputWithUnitField label='Direita' name='right' />
                </Grid.Col>
              </Grid.Row>
            </Stack>
