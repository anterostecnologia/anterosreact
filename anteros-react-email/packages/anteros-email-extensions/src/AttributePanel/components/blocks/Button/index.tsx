...
import { IconFont, useEditorProps, useFocusIdx } from '@anterostecnologia/anteros-email-editor';
      ...
      <CollapseWrapper defaultActiveKey={['-1', '0', '1', '2', '3']}>
        ...
        <Collapse.Item name='0' header='Dimensão'>
          <Space direction='vertical'>
            ...
            <Padding title='Espaçamento interno' attributeName='inner-padding' />
          </Space>
        </Collapse.Item>

        <Collapse.Item name='1' header='Cor'>
          <Space direction='vertical'>
            <Grid.Row>
              <Grid.Col span={11}>
                <Color title='Cor título' />
              </Grid.Col>
              <Grid.Col offset={1} span={11}>
                <BackgroundColor title='Cor botão' />
              </Grid.Col>
              <Grid.Col span={11}>
