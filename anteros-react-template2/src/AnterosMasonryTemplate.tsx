...
class AnterosMasonryTemplate<T extends AnterosEntity, TypeID> extends Component<
  AnterosMasonryTemplateProps<T, TypeID>,
  AnterosMasonryTemplateState
> {
  ...
  createDataSourceFilter(
    props: AnterosMasonryTemplateProps<T, TypeID>
  ): AnterosRemoteDatasource {
  ...
  createItems() {
    ...
    let result = new Array<typeof ViewItem>();
      ...
      <Fragment>
        ...
        >
          ...
          <AnterosMasonry
            ...
            elementType={"ul"}
            id={"masonry" + this.props.viewName}
            options={{
          ...
          >
            {!this._dataSource.isEmpty() ? this.createItems() : null}
          </AnterosMasonry>
        </AnterosBlockUi>
...
export class MasonryTemplateActions extends Component {
  render() {
