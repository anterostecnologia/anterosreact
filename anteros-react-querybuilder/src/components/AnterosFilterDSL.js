import { Anteros, AnterosStringUtils,AnterosDateUtils } from 'anteros-react-core';
        ...
        rules.forEach(function (rule) {
            if (rule.field && !rule.disabled) {
                ...
                if (rule.dataType == 'date') {
                    newValue = AnterosDateUtils.formatDate(AnterosDateUtils.parseDateWithFormat(newValue, 'DD/MM/YYYY'), Anteros.dataSourceDatetimeFormat);
                } else if (rule.dataType == 'date_time') {
                    newValue = AnterosDateUtils.formatDate(AnterosDateUtils.parseDateWithFormat(newValue, 'DD/MM/YYYY hh:mm:ss'), Anteros.dataSourceDatetimeFormat);
                }

                if (newValue2) {
                    if (rule.dataType == 'date') {
                        newValue2 = AnterosDateUtils.formatDate(AnterosDateUtils.parseDateWithFormat(newValue2, 'DD/MM/YYYY'), Anteros.dataSourceDatetimeFormat);
                    } else if (rule.dataType == 'date_time') {
                        newValue2 = AnterosDateUtils.formatDate(AnterosDateUtils.parseDateWithFormat(newValue2, 'DD/MM/YYYY hh:mm:ss'), Anteros.dataSourceDatetimeFormat);
                    }
                }
