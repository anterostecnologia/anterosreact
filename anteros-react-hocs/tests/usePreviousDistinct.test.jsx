...
import usePreviousDistinct from '../src/hooks/usePreviousDistinct';
describe('usePreviousDistinct', () => {
    it('should be defined', () => {
        expect(usePreviousDistinct).toBeDefined();
    });
    function getHook(initialValue, predicate) {
        return renderHook(({ val, cmp }) => usePreviousDistinct(val, cmp), {
            initialProps: {
                val: initialValue || 0,
                cmp: predicate,
            },
