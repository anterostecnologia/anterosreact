...
import useStateValidator from '../src/hooks/useStateValidator';
describe('useStateValidator', () => {
    it('should be defined', () => {
        expect(useStateValidator).toBeDefined();
    });
    function getHook(fn = jest.fn((state) => [!!(state % 2)])) {
        return [
            fn,
            renderHook(() => {
