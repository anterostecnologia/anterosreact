...
export class AnterosChatInput extends Component {
    onChange(e) {
    ...
    render() {
        return (
            <div className={classNames('chat-container-input', this.props.className)}>
                {
                ...
                }
                {
                    ...
                    <textarea
                        ...
                        type={this.props.type}
                        className={classNames('chat-input', 'chat-input-textarea')}
                        placeholder={this.props.placeholder}
                        defaultValue={this.props.defaultValue}
                        style={this.props.inputStyle}
                        onChange={this.onChange.bind(this)}
...
export default AnterosChatInput;
