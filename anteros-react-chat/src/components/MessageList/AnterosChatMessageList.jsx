...
import AnterosChatMessageBox from '../MessageBox/AnterosChatMessageBox';
import {AnterosIcon} from '@anterostecnologia/anteros-react-image';


const classNames = require('classnames');

export class AnterosChatMessageList extends Component {
    ...
    render() {
        return (
            <div
                className={classNames(['chat-container-mlist', this.props.className])}>
                <div
                    ref={this.loadRef}
                    onScroll={this.onScroll}
                    className='chat-mlist'>
                    {
                        this.props.dataSource.map((x, i) => (
                            <AnterosChatMessageBox
                                key={i}
                                {...x}
                ...
                </div>
                {
                    ...
                    <div
                        className='chat-mlist-down-button'
                        onClick={this.toBottom.bind(this)}>
                        <AnterosIcon icon="fal fa-chevron-down"/>
                        {
                            this.props.downButtonBadge &&
                            <span
                                className='chat-mlist-down-button--badge'>
                                {this.props.downButtonBadge}
                            </span>
                        }
                    </div>
...
AnterosChatMessageList.defaultProps = {
    onClick: null,
    onTitleClick: null,
    onForwardClick: null,
    onReplyClick: null,
...
export default AnterosChatMessageList;
