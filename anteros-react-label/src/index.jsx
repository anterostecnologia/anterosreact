...
import AnterosAvatar, {RedirectSource, GoogleSource, InstagramSource, ValueSource,
    ...
    withConfig, ConfigProvider, cache, createAvatarComponent} from "./components/AnterosAvatar";


export {
    AnterosBadge,AnterosCustomLabel,AnterosLabel,AnterosStatusMark,AnterosText,AnterosTruncateText,
