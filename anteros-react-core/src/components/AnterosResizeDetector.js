...
class AnterosResizeDetector extends PureComponent {
  constructor(props) {
    super(props);

    this.getElement = this.getElement.bind(this);
    this.createResizeHandler = this.createResizeHandler.bind(this);
    this.handleRenderProp = this.handleRenderProp.bind(this);
...
export default AnterosResizeDetector;