...
export default class AnterosLookupCombobox extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.dataSource) {
      ...
      if (value) value = value[nextProps.lookupDataFieldText];
    }
    if (value === "") {
      value = [];
    }
  ...
  onDatasourceEvent(event, error) {
    if (this.props.dataSource) {
      ...
      if (this.props.dataSource) {
        value = this.props.dataSource.fieldByName(this.props.dataField);
        if (value) value = value[this.props.lookupDataFieldText];
      }
      this.setState({
        ...this.state,
        value
  ...
  onChangeSelect(event, selectedValue) {
    ...
    let value = this.props.dataSource.fieldByName(nextProps.dataField);
    if (value) {
      value = value[this.props.dataSource.lookupDataFieldText];
    }
    if (value === "") {
      value = [];
    }
