...
import { AnterosJacksonParser,AnterosStringUtils,AnterosObjectUtils,AnterosUtils } from "@anterostecnologia/anteros-react-core";
...
export default class AnterosLookupNumber extends React.Component {
    constructor(props) {
        super(props);
        this.idEdit = lodash.uniqueId("lkpNumber");
...
AnterosLookupNumber.contextTypes = {
    withinInputGroup: PropTypes.bool
};


AnterosLookupNumber.propTypes = {
...
AnterosLookupNumber.defaultProps = {
    value: '',
    readOnly: false,
    validateOnExit: true,
