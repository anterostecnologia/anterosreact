...
export default class AnterosEdit extends AnterosBaseInputControl {
  ...
  render() {
    ...
    let { required, minLength, maxLength, pattern, clear } = this.props;
    ...
    let classNameInput = AnterosUtils.buildClassNames(
      colClasses.length > 0 || icon || this.props.onlyInput
        ? "form-control"
        : "",
      this.props.classNameInput ? this.props.classNameInput : "",
    ...
    if (this.props.icon) {
      ...
      const edit = this.props.onlyInput ? (
        <input
          ...
          style={{
            ...this.props.style,
            width: this.props.width ? "100%" : null,
          }}
          className={classNameInput}
          onFocus={this.props.onFocus}
          readOnly={readOnly}
