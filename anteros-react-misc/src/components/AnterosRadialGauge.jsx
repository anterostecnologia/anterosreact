...
//https://veerasundar.com/gauge-generator

const TICK_ID = 'tick';

export default class AnterosRadialGauge extends Component {
    constructor(props){
        super(props);
        this.renderDial = this.renderDial.bind(this);
        this.defineTick = this.defineTick.bind(this);
...
AnterosRadialGauge.defaultProps = {
    size: 200,
