...
class AnterosWidgetDoughnutChart extends Component{
...
AnterosWidgetDoughnutChart.propTypes = {
...
AnterosWidgetDoughnutChart.defaultProps = {
    
}

export default AnterosWidgetDoughnutChart